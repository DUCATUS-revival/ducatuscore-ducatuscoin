...
#if defined(NDEBUG)
# error "Ducatuscoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Ducatuscoin Signed Message:\n";
...
bool ContextualCheckBlockHeader(const CBlockHeader& block, CValidationState& state, const Consensus::Params& consensusParams, CBlockIndex * const pindexPrev, int64_t nAdjustedTime)
{
    ...
    // Ducatuscoin: Reject block.nVersion=1 blocks (mainnet >= 710000, testnet >= 400000, regtest uses supermajority)
